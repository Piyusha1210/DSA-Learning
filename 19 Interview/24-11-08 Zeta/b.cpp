 ...
 * if input is null -> then return minimum available number.
 * If input is not null  -> then it's priority number return that that input number if it's available, if not available then return null;
*/ 
